...
<div id="page-wrapper">
  <header<?php print $header_attributes; ?>>
    <nav<?php print $navbar_attributes; ?>>
      ...
      <?php if ($logo): ?>
        <a href="<?php print $front_page; ?>" class="uk-navbar-brand uk-navbar-center uk-visible-small" title="<?php print t('Home'); ?>" rel="home" id="logo-small">
          <img src="<?php print $logo_small; ?>" alt="<?php print t('Home'); ?>"/>
        </a>
      <?php endif; ?>
    </nav>
  </header>
