 ...
 */
?>
<div id="api-function-signatures" class="uk-margin-small-bottom">
...
<div id="docs-api">
  ...
  <?php if (!empty($parameters)): ?>
    <div id="docs-api-parameters" class="uk-margin-bottom">
  ...
  <?php if (!empty($return)): ?>
    <div id="docs-api-return-value" class="uk-margin-bottom">
  ...
  <?php if (!empty($throws)): ?>
    <div id="docs-api-throws" class="uk-margin-bottom">
