  ...
  <div class="uk-container uk-container-expand">
    <nav<?php print $navbar_attributes; ?>>
      <div class="uk-navbar-left">
        <?php if (!drupal_is_front_page() && ($logo || $site_name)): ?>
...
<div<?php print $page_container_attributes; ?>>
  ...
  <div class="uk-grid" uk-grid>
    ...
    <?php if (!drupal_is_front_page() && $page['sidebar_first']): ?>
      <div<?php print $sidebar_first_attributes; ?>>
        <?php print render($page['sidebar_first']); ?>
      </div>
    <?php endif; ?>

    <?php if (!drupal_is_front_page() && $page['sidebar_second']): ?>
...
<?php if ($page['footer']): ?>
  <div class="uk-grid uk-margin-top" uk-grid>
    <div id="footer" class="uk-width-1-1 uk-text-center uk-flex-center">
