 ...
 * The required UIkit, jQuery v2.1.4 and jQuery Migrate v1.4.1 libraries are
 ...
 *
 * @link https://ftp.drupal.org/files/projects/uikit-7.x-2.6.tar.gz UIkit 7.x-2.6.tar.gz @endlink
 * @link https://ftp.drupal.org/files/projects/uikit-7.x-2.6.zip UIkit 7.x-2.6.zip @endlink
 *
 ...
 * release.
 * @code git clone --branch 7.x-2.x https://git.drupal.org/project/uikit.git @endcode
 *
 ...
 * - @ref navigations
 *
 * @section theme-styles Theme styles
