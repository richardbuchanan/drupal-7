NOTE: This module is a rewritten version of the original API module.
- https://www.drupal.org/project/api

This module is maintained by Richard Buchanan at Buchanan Design
Group
- https://www.drupal.org/u/richard-buchanan
- https://github.com/richardbuchanan
- https://buchanandesigngroup.com

The original module readme is found below.
--------------------------------------------------------------------------------
